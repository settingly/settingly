    ...
    <div class="space-y-8 text-dark">
        ...
        <div class="space-y-1">
          <p>
            ...
            <NuxtLink
              ...
              to="mailto:contact@settingly.xyz"
              >contact@settingly.xyz
            </NuxtLink>
          </p>
        </div>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          on these pages under the general laws according to § 7 para.1 TMG.
          ...
          of the law becomes known. If we become aware of any such
